...
final class Version20210909142124 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `source` (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, unit VARCHAR(60) DEFAULT NULL, resolution INT NOT NULL, max_value DOUBLE PRECISION NOT NULL, INDEX name_idx (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `source_data` (id INT AUTO_INCREMENT NOT NULL, source_id INT NOT NULL, import_id INT NOT NULL, target_date DATE NOT NULL, created_date DATE NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, value DOUBLE PRECISION DEFAULT NULL, INDEX IDX_AC797660953C1C61 (source_id), INDEX IDX_AC797660B6A263D9 (import_id), INDEX source_idx (source_id, created_date, target_date, latitude, longitude), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
