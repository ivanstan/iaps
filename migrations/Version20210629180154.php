 ...
 */
final class Version20210629180154 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE import (id INT AUTO_INCREMENT NOT NULL, datetime DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `source_data` (id INT AUTO_INCREMENT NOT NULL, source_id INT NOT NULL, import_id INT NOT NULL, datetime DATETIME NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, value DOUBLE PRECISION DEFAULT NULL, INDEX IDX_AC797660953C1C61 (source_id), INDEX IDX_AC797660B6A263D9 (import_id), INDEX source_idx (source_id, datetime, latitude, longitude), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
